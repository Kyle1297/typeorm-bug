...
import { InvalidCredentialsError } from 'src/server/app/auth/responses/invalid_credentials.error';
import { AuthUserResponse } from 'src/server/app/auth/responses/auth_user.response';
import { InvalidInputError } from 'src/server/app/graphql/responses/invalid_input.error';
import { CredentialsTakenError } from 'src/server/app/auth/responses/credentials_taken.error';
import { SocialNotRegisteredError } from 'src/server/app/auth/responses/social_not_registered.error';
import { SocialAlreadyAssignedError } from 'src/server/app/auth/responses/social_already_assigned.error';
import {
  socialProviderTypes,
  SocialProviderTypes,
} from 'src/server/app/auth/scalars/social_provider.scalar';
