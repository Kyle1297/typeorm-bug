...
import { productFeatureOptionFactory } from 'test/factories/product_feature_option.factory';
...
describe('ProductModule (e2e)', () => {
  ...
  describe('product query', () => {
    ...
    it('should return product', async () => {
      ...
      expect(result.body.data.product.price.audInCents).toBe(
        productPrice.audInCents,
      );
      ...
      expect(
        result.body.data.product.features[0].options[0].price.audInCents,
  ...
  describe('products query', () => {
    ...
    it('should return products', async () => {
      ...
      expect(result.body.data.products[0].price.audInCents).toBe(
        productOnePrice.audInCents,
      );
      ...
      expect(
        result.body.data.products[0].features[0].options[1].price.audInCents,
      ...
      expect(
        result.body.data.products[0].features[1].options[0].price.audInCents,
      ...
      expect(result.body.data.products[1].price.audInCents).toBe(
        productTwoPrice.audInCents,
      );
      ...
      expect(
        result.body.data.products[1].features[0].options[0].price.audInCents,
      ).toBe(optionThreePrice.audInCents);
      expect(
